...
- Validity period entry next to the expiration date: pick or type a period (`45 days`, `1 month`, `5 years`) and the expiration date is computed from today. The date picker stays directly editable; a manual date edit clears the period text.
