...
public class WindowSettingsManager
{
    ...
    private void ScanControls()
    {
        ...
        if (_window.Content is FrameworkElement rootElement)
        {
            ...
            {
                if (!string.IsNullOrEmpty(element.Name) && !_controls.ContainsKey(element.Name))
                    _controls.Add(element.Name, element);
            }
        }
        ...
        {
            if (!string.IsNullOrEmpty(fe.Name) && !_controls.ContainsKey(fe.Name))
    ...
    private List<FrameworkElement> FindAllNamedElements(FrameworkElement element)
    {
        ...
        foreach (var field in fields)
        {
            ...
            {
                var control = field.GetValue(_window) as FrameworkElement;
    ...
    private static IEnumerable<FrameworkElement> FindNamedControls(DependencyObject parent)
    {
        ...
        // Search logical tree first (important for XAML defined elements)
